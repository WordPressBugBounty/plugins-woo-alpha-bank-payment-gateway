...
if ( class_exists( '\Automattic\WooCommerce\Blocks\Payments\Integrations\AbstractPaymentMethodType' ) ) {
    ...
    final class WC_AlphaBank_Gateway_Checkout_Block extends \Automattic\WooCommerce\Blocks\Payments\Integrations\AbstractPaymentMethodType {
        private $gateway;
        protected $name = 'alphabank_gateway';

        public function initialize() {
            $this->gateway = new WC_AlphaBank_Gateway();
        }
    ...
    final class WC_AlphaBank_Gateway_Checkout_Block {
